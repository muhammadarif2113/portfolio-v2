          ...
          <div className="row contact section-padding">
            ...
            <div className="col s12 m5 l5 xl4 leftside">
              ...
              <span className="font-weight-400 second-font">
                <i className="fa fa-envelope" /> saim@saimdev.com
              </span>
              <h6 className="font-weight-700 uppercase">Address</h6>
              <span className="font-weight-400 second-font">
                <i className="fa fa-home" /> New York, NY
              </span>
              <br />
              {/* Contacts Ends */}
              ...
              <div className="social">
                ...
                <li className="linkedin">
                    <a href="https://www.linkedin.com/in/muhammad-arif-2a9784163">
                      <i className="fa fa-linkedin" />
                    </a>
                  </li>
                  <li className="google-plus">
                    <a href="https://github.com/muhammadarif2113?tab=repositories">
            ...
            <div className="col s12 m7 l7 xl8 rightside">
              ...
              <div className="row">
                <p className="col s12 m12 l12 xl10 second-font">
                  If you have any suggestions, projects, or just want to chat,
                  please fill out the form below and I will reply to you
                  shortly.
                </p>
              </div>
